...
#define MMI_GX_MAGICSUSHI_BACKGROUND1_X2 (100)
...
#define MMI_GX_MAGICSUSHI_DIGIT_HEIGHT    (9)
#define MMI_GX_MAGICSUSHI_DIGIT_HEIGHT    (9)
#define MMI_GX_MAGICSUSHI_LEFT_WIDTH   (8)
#define MMI_GX_MAGICSUSHI_RIGHT_WIDTH  (8)
...
#elif defined(__MMI_MAINLCD_536X240__)

#define MMI_GX_MAGICSUSHI_LCD_HEIGHT         (240)
#define MMI_GX_MAGICSUSHI_LCD_WIDTH          (536)
#define MMI_GX_MAGICSUSHI_ORIGIN_X           (101)
#define MMI_GX_MAGICSUSHI_ORIGIN_Y           (5)

#define MMI_GX_MAGICSUSHI_SIZE               (38)
#define MMI_GX_MAGICSUSHI_ANIMATION_STEP     (3)

/* BACKBROUND 2 */
#define MMI_GX_MAGICSUSHI_TIME_POSITION_X (511)
#define MMI_GX_MAGICSUSHI_TIME_POSITION_Y (49)
#define MMI_GX_MAGICSUSHI_REMAINDER_POSITION_X  (521)
#define MMI_GX_MAGICSUSHI_REMAINDER_POSITION_Y  (101)

#define MMI_GX_MAGICSUSHI_TIME_MAX_WIDTH (120)

#define MMI_GX_MAGICSUSHI_BACKGROUND2_X1 (460)
#define MMI_GX_MAGICSUSHI_BACKGROUND2_Y1 (35)
#define MMI_GX_MAGICSUSHI_BACKGROUND2_X2 (535)
#define MMI_GX_MAGICSUSHI_BACKGROUND2_Y2 (120)

#define MMI_GX_MAGICSUSHI_SOFTKEY_X (486)
#define MMI_GX_MAGICSUSHI_SOFTKEY_Y (210)
#define MMI_GX_MAGICSUSHI_SOFTKEY_WIDTH (40)
#define MMI_GX_MAGICSUSHI_SOFTKEY_HEIGHT (20)
/* END OF BACKGROUND 2 */

/* BACKBROUND 1 */
#define MMI_GX_MAGICSUSHI_SCORE_POSITION_X (61)
#define MMI_GX_MAGICSUSHI_SCORE_POSITION_Y (185)
#define MMI_GX_MAGICSUSHI_LEVEL_POSITION_X   (46)
#define MMI_GX_MAGICSUSHI_LEVEL_POSITION_Y   (155)

#define MMI_GX_MAGICSUSHI_BACKGROUND1_X1 (46)
#define MMI_GX_MAGICSUSHI_BACKGROUND1_Y1 (150)
#define MMI_GX_MAGICSUSHI_BACKGROUND1_X2 (66)
#define MMI_GX_MAGICSUSHI_BACKGROUND1_Y2 (200)
/* END OF BACKGROUND 1 */

#define MMI_GX_MAGICSUSHI_DIGIT_WIDTH     (7)
#define MMI_GX_MAGICSUSHI_LEFT_WIDTH   (101)
#define MMI_GX_MAGICSUSHI_RIGHT_WIDTH  (0)
#define MMI_GX_MAGICSUSHI_TOP_WIDTH    (5)
#define MMI_GX_MAGICSUSHI_FOOD_AREA_WIDTH (380)
#define MMI_GX_MAGICSUSHI_FOOD_AREA_HEIGHT (228)

#define MMI_GX_MAGICSUSHI_HINT_POSITION_X (20)
#define MMI_GX_MAGICSUSHI_HINT_POSITION_Y (80)

#define MMI_GX_MAGICSUSHI_GAMEOVER_SCORE_POSITION_X (56)
#define MMI_GX_MAGICSUSHI_GAMEOVER_SCORE_POSITION_Y (190)

#define MMI_GX_MAGICSUSHI_TIME_WIDTH   (8)

#endif

#define MMI_GX_MAGICSUSHI_COLS 10
#define MMI_GX_MAGICSUSHI_ROWS 6
#define MMI_GX_MAGICSUSHI_LAST_COL (MMI_GX_MAGICSUSHI_COLS - 1)
#define MMI_GX_MAGICSUSHI_LAST_ROW (MMI_GX_MAGICSUSHI_ROWS - 1)
#ifndef MMI_GX_MAGICSUSHI_DIGIT_HEIGHT
#define MMI_GX_MAGICSUSHI_DIGIT_HEIGHT (9)
#endif
...
{                                                                                \
   ...
   g_gx_magicsushi_context.i_map[i][j] = MMI_GX_MAGICSUSHI_ROWS;                 \
}                                                                                \
...
typedef struct
{
    ...
    U8 map[MMI_GX_MAGICSUSHI_COLS][MMI_GX_MAGICSUSHI_ROWS];
    U8 i_map[MMI_GX_MAGICSUSHI_COLS][MMI_GX_MAGICSUSHI_ROWS];
    U8 type_num;
    S16 solution_start_vertical[MMI_GX_MAGICSUSHI_COLS][4];
    S16 solution_end_vertical[MMI_GX_MAGICSUSHI_COLS][4];
    S16 solution_start_horizontal[MMI_GX_MAGICSUSHI_ROWS][4];
    S16 solution_end_horizontal[MMI_GX_MAGICSUSHI_ROWS][4];
...
static S16 mmi_gx_magicsushi_draw_number_right(S16 x, S16 y, U32 digit) {
    S16 tmp_digit;
    S16 tmp_grade;
    S16 position_x;
    position_x = x;
...
static void mmi_gx_magicsushi_draw_slash(S16 x, S16 y) {
    S16 left = x - (MMI_GX_MAGICSUSHI_DIGIT_WIDTH - 1);
    S16 top = y;
    S16 height = MMI_GX_MAGICSUSHI_DIGIT_HEIGHT;
    S16 width = MMI_GX_MAGICSUSHI_DIGIT_WIDTH;
    S16 i;
    for (i = 0; i < width; i++)
    {
        S16 px = left + i;
        S16 py = top + (height - 1) - (i * (height - 1) / (width - 1));
        gdi_draw_solid_rect(px, py, px, py, fg_color);
    }
}

static void mmi_gx_magicsushi_draw_fraction(S16 x, S16 y, U32 numerator, U32 denominator) {
    S16 position_x;
    const S16 slash_gap = 1;
    const S16 number_gap = 1;
    position_x = mmi_gx_magicsushi_draw_number_right(x + 3, y, denominator);
    position_x = position_x - slash_gap;
    gdi_image_draw_id(position_x - (MMI_GX_MAGICSUSHI_DIGIT_WIDTH - 1) + 5, y, IMG_ID_GX_MAGICSUSHI_NUMBER_SLASH);
    position_x = position_x - (MMI_GX_MAGICSUSHI_DIGIT_WIDTH - number_gap);
    mmi_gx_magicsushi_draw_number_right(position_x - 3, y, numerator);
}
...
void mmi_gx_magicsushi_draw_dynamic_background(void)
{
    ...
    /* draw left time */
    {
        ...
        {
            g_gx_magicsushi_context.remain_time = 0;
        }
        ...
        mmi_gx_magicsushi_draw_digit(
            MMI_GX_MAGICSUSHI_TIME_POSITION_X,
            MMI_GX_MAGICSUSHI_TIME_POSITION_Y,
            (U32) g_gx_magicsushi_context.remain_time);
    }
    ...
    gdi_draw_solid_rect(
        ...
        91 + 23 - 1,
        GDI_COLOR_TRANSPARENT);
    mmi_gx_magicsushi_draw_fraction(
        MMI_GX_MAGICSUSHI_REMAINDER_POSITION_X,
        MMI_GX_MAGICSUSHI_REMAINDER_POSITION_Y,
        (U32) g_gx_magicsushi_context.remainder,
        50);
...
void mmi_gx_magicsushi_render(void)
{
    ...
    if (g_gx_magicsushi_context.last_key != 0)
    {
        ...
        y = (MMI_GX_MAGICSUSHI_LAST_ROW - j) * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_TOP_WIDTH;
    ...
    y = (MMI_GX_MAGICSUSHI_LAST_ROW - g_gx_magicsushi_context.cursor_y) * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_TOP_WIDTH;
    ...
    {
        y = (MMI_GX_MAGICSUSHI_LAST_ROW - g_gx_magicsushi_context.old_y) * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_TOP_WIDTH;
    ...
    switch (g_gx_magicsushi_context.animation_mode)
    {
        ...
        case 2:
            ...
            {
                for (i = 0; i < MMI_GX_MAGICSUSHI_COLS; i++)
                    for (j = 0; j < MMI_GX_MAGICSUSHI_ROWS; j++)
        ...
        case 3:
            ...
            if (g_gx_magicsushi_context.animation_step == 0)
            {
                for (i = 0; i <= 2; i++)
                {
                    if (g_gx_magicsushi_context.old_x + i - 1 < 0 || g_gx_magicsushi_context.old_x + i - 1 > MMI_GX_MAGICSUSHI_LAST_COL)
                    {
                        continue;
                    }
                    else
                    ...
                    for (j = 0; j <= 2; j++)
                    {
                        if (g_gx_magicsushi_context.old_y + j - 1 < 0 || g_gx_magicsushi_context.old_y + j - 1 > MMI_GX_MAGICSUSHI_LAST_ROW)
                        {
                            continue;
                        }
                        else
                        {
                            y = (MMI_GX_MAGICSUSHI_ROWS - g_gx_magicsushi_context.old_y - j) * MMI_GX_MAGICSUSHI_SIZE +
        ...
        case 4:
            ...
            {
                x = (g_gx_magicsushi_context.old_x) * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_LEFT_WIDTH;
                for (i = 0; i < MMI_GX_MAGICSUSHI_ROWS; i++)
                {
                    y = (MMI_GX_MAGICSUSHI_LAST_ROW - i) * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_TOP_WIDTH;
                    gdi_image_draw_id(x, y, IMG_ID_GX_MAGICSUSHI_SELECTED);
        ...
        case 5:
            ...
            y = (MMI_GX_MAGICSUSHI_LAST_ROW - g_gx_magicsushi_context.special_y) * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_TOP_WIDTH;
            gdi_draw_solid_rect(x, y, x + MMI_GX_MAGICSUSHI_SIZE - 1, y + MMI_GX_MAGICSUSHI_SIZE - 1, GDI_COLOR_TRANSPARENT);

            x = g_gx_magicsushi_context.old_x * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_LEFT_WIDTH;
            y = (MMI_GX_MAGICSUSHI_LAST_ROW - g_gx_magicsushi_context.old_y) * MMI_GX_MAGICSUSHI_SIZE
            ...
            y = (MMI_GX_MAGICSUSHI_LAST_ROW - g_gx_magicsushi_context.special_y) * MMI_GX_MAGICSUSHI_SIZE
                - (S32) (tmpfloat * MMI_GX_MAGICSUSHI_SIZE) + MMI_GX_MAGICSUSHI_TOP_WIDTH;
            gdi_image_draw_id(
                x,
                y,
        ...
        case 6:
            ...
            for (i = 0; i < MMI_GX_MAGICSUSHI_COLS; i++)
            {
                ...
                for (j = 0; j < MMI_GX_MAGICSUSHI_ROWS; j++)
                {
                    ...
                    {
                        x = i * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_LEFT_WIDTH;
                        y = (MMI_GX_MAGICSUSHI_ROWS - g_gx_magicsushi_context.i_map[i][j]) * MMI_GX_MAGICSUSHI_SIZE
                        ...
                        {
                            x = i * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_LEFT_WIDTH;
                            y = (MMI_GX_MAGICSUSHI_LAST_ROW - k) * MMI_GX_MAGICSUSHI_SIZE
                                + MMI_GX_MAGICSUSHI_TOP_WIDTH - (S32) (tmpfloat * MMI_GX_MAGICSUSHI_SIZE);
                            gdi_draw_solid_rect(
                                x,
                                y,
                        ...
                        if (tmp == 0)
                        {
                            ...
                            if (g_gx_magicsushi_context.i_map[i][j] == MMI_GX_MAGICSUSHI_LAST_ROW)
                            {
                                break;
                            }
                        }

                        if (g_gx_magicsushi_context.i_map[i][j] == MMI_GX_MAGICSUSHI_ROWS)
                        {
                            break;
                        }
                    }
...
void mmi_gx_magicsushi_pen_down_hdlr(mmi_pen_point_struct pos)
{
    ...
    if (!g_gx_magicsushi_context.moving)
    {
        ...
        coord_y = MMI_GX_MAGICSUSHI_LAST_ROW - (pos_y - MMI_GX_MAGICSUSHI_ORIGIN_Y) / MMI_GX_MAGICSUSHI_SIZE;
        ...
        if (coord_x < MMI_GX_MAGICSUSHI_COLS && coord_x >= 0 && coord_y < MMI_GX_MAGICSUSHI_ROWS && coord_y >= 0)
        {
...
void mmi_gx_magicsushi_enter_game(void)
{
    ...
    sushi_debug_mark(42);
    gdi_layer_clear_background(GDI_COLOR_BLUE);
    sushi_debug_mark(43);
...
void mmi_gx_magicsushi_key_2_release(void)
{
    ...
    if (g_gx_magicsushi_context.cursor_y < MMI_GX_MAGICSUSHI_LAST_ROW)
    {
...
void mmi_gx_magicsushi_key_6_release(void)
{
    ...
    if (g_gx_magicsushi_context.cursor_x < MMI_GX_MAGICSUSHI_LAST_COL)
    {
        if (g_gx_magicsushi_context.is_frame_need_updated) /*the previous frame do not updated yet, so give up this move*/
        {
            return;
...
void mmi_gx_magicsushi_key_5_release(void)
{
    ...
    /* Code Body                                                      */
    /*----------------------------------------------------------------*/
    if (g_gx_magicsushi_context.is_gameover)
    {
        mmi_gx_magicsushi_enter_game();
        return;
    }
...
void mmi_gx_magicsushi_show_magicsushi()
{
    ...
    {
        y = (MMI_GX_MAGICSUSHI_LAST_ROW - i) * MMI_GX_MAGICSUSHI_SIZE + MMI_GX_MAGICSUSHI_TOP_WIDTH;
        for (j = 0; j < MMI_GX_MAGICSUSHI_COLS; j++)
        {
...
void mmi_gx_magicsushi_cyclic_timer(void)   /* done */
{
    ...
    if (g_gx_magicsushi_context.tick % 10 == 0)
    {
        ...
        sushi_debug_time(
            g_gx_magicsushi_context.tick,
            g_gx_magicsushi_context.remain_time,
            g_gx_magicsushi_context.remainder);
...
U8 mmi_gx_magicsushi_check_pair(U8 x1, U8 y1, U8 x2, U8 y2, U8 horizontal)      /* done */
{
    ...
    if (horizontal)
    {
        ...
        if (dy2 > MMI_GX_MAGICSUSHI_LAST_ROW)
        {
            dy2 = MMI_GX_MAGICSUSHI_LAST_ROW;
        }
        if (dx1 < 0)
        {
            dx1 = 0;
        }
        if (dx2 > MMI_GX_MAGICSUSHI_LAST_COL)
        {
            dx2 = MMI_GX_MAGICSUSHI_LAST_COL;
        }
...
void mmi_gx_magicsushi_gen_map()    /* done */
{
    ...
    g_gx_magicsushi_context.animation_step = MMI_GX_MAGICSUSHI_ROWS * MMI_GX_MAGICSUSHI_ANIMATION_STEP;
...
void mmi_gx_magicsushi_update_map() /* done */
{
    ...
    for (i = 0; i < MMI_GX_MAGICSUSHI_COLS; i++)
    {
        ...
        for (j = MMI_GX_MAGICSUSHI_ROWS - movesteps; j < MMI_GX_MAGICSUSHI_ROWS; j++)
        {
            RAND_ITEM(i, j, item);
        }
...
MMI_BOOL mmi_gx_magicsushi_is_current_move_ok(U8 i, U8 j, U8 food, mmi_gx_magicsushi_direction_enum direction)
{
    ...
    {
        if (j <= (MMI_GX_MAGICSUSHI_LAST_ROW - 2))
        {
    ...
    {
        if (i <= (MMI_GX_MAGICSUSHI_LAST_COL - 2))
        {
            if (g_gx_magicsushi_context.map[i+1][j] == food &&
                g_gx_magicsushi_context.map[i+2][j] == food)
            {
    ...
    {
        if ((i >= 1) && (i <= (MMI_GX_MAGICSUSHI_LAST_COL - 1)))
        {
    ...
    {
        if ((j >= 1) && (j <= (MMI_GX_MAGICSUSHI_LAST_ROW - 1)))
        {
...
U8 mmi_gx_magicsushi_is_moremove()  /* done */
{
    ...
    for (i = 0; i <= MMI_GX_MAGICSUSHI_LAST_COL; i++)
    {
        for (j = 0; j <= MMI_GX_MAGICSUSHI_LAST_ROW; j++)
        {
            U8 food = g_gx_magicsushi_context.map[i][j];

            /*current move up*/
            if (j <= (MMI_GX_MAGICSUSHI_LAST_ROW - 1))
            {
            ...
            /*current move right*/
            if (i <= (MMI_GX_MAGICSUSHI_LAST_COL - 1))
            {
