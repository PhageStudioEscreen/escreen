...
void pgs_backlist_add_item(const char * text, void * icon, lv_event_cb_t event_cb)
{
    ...
    lv_obj_set_size(item->container, 238, 28);
    ...
    lv_obj_set_x(item->icon, 0);
    lv_obj_set_y(item->icon, 4);
    ...
    lv_obj_set_x(item->text, 20);
    lv_obj_set_y(item->text, 5);
...
static lv_obj_t * _pgs_backlist_init(lv_obj_t * obj, lv_group_t * group, void (*key_cb)(uint32_t keycode), bool nomenu)
{
    ...
    lv_obj_set_width(ui_container_backlist, 320);
    lv_obj_set_height(ui_container_backlist, 172 * 2);
    ...
    lv_obj_set_width(ui_container_list, 320);
    lv_obj_set_height(ui_container_list, 172);
    lv_obj_set_y(ui_container_list, 172 / 2);
